...
pub fn generate_water<'a>(size: usize) -> Water<'a> {
    ...
    fn get_indicators(corner_pos: [Vec3; 4], current: usize, v1: usize, v2: usize) -> [u8; 4] {
    ...
    fn push_triangle(verts: &mut Vec<WaterVertex>, corner_pos: [Vec3; 4], left: bool) {
        ...
        verts.push(WaterVertex::from((
            corner_pos[i0],
            get_indicators(corner_pos, i0, i2, i1),
        )));
        verts.push(WaterVertex::from((
            corner_pos[i1],
            get_indicators(corner_pos, i1, i0, i2),
        )));
        verts.push(WaterVertex::from((
            corner_pos[i2],
            get_indicators(corner_pos, i2, i1, i0),
        )));
    }
